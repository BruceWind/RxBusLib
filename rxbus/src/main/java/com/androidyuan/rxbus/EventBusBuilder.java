...
import com.androidyuan.rxbus.component.SubscriberInfoIndex;
 ...
 * Create a new builder using {@link EventBusBuilder#build()}.
 */
public class EventBusBuilder {
    ...
    /**
     * @throws RxBus if there's already a default EventBus instance in place
     */
    public RxBus installDefaultEventBus() {
        synchronized (RxBus.class) {
            if (RxBus.instance != null) {
                throw new BusException("Default instance already exists." +
                        " It may be only set once before it's used the first time to ensure consistent behavior.");
            }
            RxBus.instance = build();
